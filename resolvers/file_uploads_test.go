...
//TestFileUpload uploads a test file
...
//
//		mutationResolver.SingleUpload = func(ctx context.Context, file graphql.Upload) (*models.File, error) {
...
//		resolver.SingleUploadWithPayload = func(ctx context.Context, req models.UploadFile) (*models.File, error) {
...
//		resolver := &mutationResolver{}
//		resolver.Mutation().MultipleUpload = func(ctx context.Context, files []*graphql.Upload) ([]*models.File, error) {
...
//		resolver := &mutationResolver{}
//		resolver.Mutation().MultipleUploadWithPayload = func(ctx context.Context, req []*models.UploadFile) ([]*models.File, error) {
//			require.Len(t, req, 2)
//			var ids []int
//			var contents []string
//			var resp []*models.File
