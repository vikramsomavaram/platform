...
func getCountryStates(countryCode string) interface{} {
	countryStates := map[string]interface{}{
		"AF": map[string]string{},
		"AO": map[string]string{ // Angola states.
			"BGO": "Bengo",
			"BLU": "Benguela",
			"BIE": "Bié",
			"CAB": "Cabinda",
		...
		"AR": map[string]string{ // Argentinian provinces.
		...
		"AU": map[string]string{ // Australian states.
		...
		"BD": map[string]string{ // Bangladeshi states (districts.
			"BD-05": "Bagerhat",
			"BD-01": "Bandarban",
			"BD-02": "Barguna",
			"BD-06": "Barishal",
		...
		"BG": map[string]string{ // Bulgarian states.
			"BG-01": "Blagoevgrad",
			"BG-02": "Burgas",
			"BG-08": "Dobrich",
			"BG-07": "Gabrovo",
		...
		"BO": map[string]string{ // Bolivian states.
			"B": "Chuquisaca",
			"H": "Beni",
			"C": "Cochabamba",
			"L": "La Paz",
		...
		"BR": map[string]string{ // Brazillian states.
			"AC": "Acre",
			"AL": "Alagoas",
			"AP": "Amap&aacute;",
			"AM": "Amazonas",
		...
		"CA": map[string]string{ // Canadian states.
			"AB": "Alberta",
			"BC": "British Columbia",
			"MB": "Manitoba",
			"NB": "New Brunswick",
		...
		"CH": map[string]string{ // Cantons of Switzerland.
			"AG": "Aargau",
		...
		"CN": map[string]string{ // Chinese states.
			"CN1":  "Yunnan / &#20113;&#21335;",
			"CN2":  "Beijing / &#21271;&#20140;",
			"CN3":  "Tianjin / &#22825;&#27941;",
			"CN4":  "Hebei / &#27827;&#21271;",
		...
		"ES": map[string]string{ // Spanish states.
			"C":  "A Coru&ntilde;a",
		...
		"GR": map[string]string{ // Greek Regions.
			"I": "Αττική",
		...
		"HK": map[string]string{ // Hong Kong states.
			"HONG KONG":       "Hong Kong Island",
			"KOWLOON":         "Kowloon",
			"NEW TERRITORIES": "New Territories",
		},
		"HU": map[string]string{ // Hungary states.
			"BK": "Bács-Kiskun",
			"BE": "Békés",
			"BA": "Baranya",
		...
		"ID": map[string]string{ // Indonesia Provinces.
		...
		"IE": map[string]string{ // Republic of Ireland.
			"CW": "Carlow",
			"CN": "Cavan",
			"CE": "Clare",
			"CO": "Cork",
		...
		"IN": map[string]string{ // Indian states.
			"AP": "Andhra Pradesh",
		...
		"IR": map[string]string{ // Iran States.
		...
		"IT": map[string]string{ // Italy Provinces.
			"AG": "Agrigento",
			"AL": "Alessandria",
			"AN": "Ancona",
			"AO": "Aosta",
		...
		"LR": map[string]string{ // Liberia provinces.
			"BM": "Bomi",
			"BN": "Bong",
			"GA": "Gbarpolu",
			"GB": "Grand Bassa",
		...
		"MD": map[string]string{ // Moldova states.
			"C":  "Chi&#537;in&#259;u",
			"BL": "B&#259;l&#539;i",
			"AN": "Anenii Noi",
			"BS": "Basarabeasca",
		...
		"MX": map[string]string{ // Mexico States.
		...
		"MY": map[string]string{ // Malaysian states.
			"JHR": "Johor",
			"KDH": "Kedah",
			"KTN": "Kelantan",
			"LBN": "Labuan",
		...
		"NG": map[string]string{ // Nigerian provinces.
			"AB": "Abia",
			"FC": "Abuja",
			"AD": "Adamawa",
			"AK": "Akwa Ibom",
		...
		"NP": map[string]string{ // Nepal states (Zones.
			"BAG": "Bagmati",
			"BHE": "Bheri",
			"DHA": "Dhaulagiri",
			"GAN": "Gandaki",
		...
		"NZ": map[string]string{ // New Zealand States.
			"NL": "Northland",
			"AK": "Auckland",
			"WA": "Waikato",
			"BP": "Bay of Plenty",
		...
		"PE": map[string]string{ // Peru states.
			"CAL": "El Callao",
		...
		"PK": map[string]string{ // Pakistan"s states.
			"JK": "Azad Kashmir",
			"BA": "Balochistan",
			"TA": "FATA",
			"GB": "Gilgit Baltistan",
		...
		"PY": map[string]string{ // Paraguay states.
		...
		"RO": map[string]string{ // Romania states.
			"AB": "Alba",
			"AR": "Arad",
			"AG": "Arge&#537;",
			"BC": "Bac&#259;u",
		...
		"TH": map[string]string{ // Thailand states.
			"TH-37": "Amnat Charoen",
			"TH-15": "Ang Thong",
			"TH-14": "Ayutthaya",
			"TH-10": "Bangkok",
		...
		"TR": map[string]string{ // Turkey States.
			"TR01": "Adana",
			"TR02": "Ad&#305;yaman",
			"TR03": "Afyon",
			"TR04": "A&#287;r&#305;",
		...
		"TZ": map[string]string{ // Tanzania States.
			"TZ01": "Arusha",
			"TZ02": "Dar es Salaam",
			"TZ03": "Dodoma",
			"TZ04": "Iringa",
		...
		"US": map[string]string{ // United States.
			"AL": "Alabama",
			"AK": "Alaska",
			"AZ": "Arizona",
			"AR": "Arkansas",
		...
		"ZA": map[string]string{ // South African states.
			"EC":  "Eastern Cape",
			"FS":  "Free State",
			"GP":  "Gauteng",
			"KZN": "KwaZulu-Natal",
